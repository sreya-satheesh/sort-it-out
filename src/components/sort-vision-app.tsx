  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2 space-y-6">
        <Card className="min-h-[50px] flex flex-col p-4 bg-card border-border">
          <div className="flex-grow flex items-end justify-center gap-1 w-full h-full min-h-[50px]">
            {currentStepData?.array.map((value, index) => {
              const { comparing, swapping, sorted, auxiliary, shifting, description } = currentStepData;
              ...
              return (
                <div key={index} className="flex flex-col items-center flex-1 h-full relative group">
                   <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-8 h-8 flex items-center justify-center">
                     {isShifting && (
